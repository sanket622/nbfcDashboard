    ...
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-96 overflow-hidden animate-scale-in">
        <div className="p-4 bg-green-50 flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-medium text-lg text-green-700">Confirm Approval</h3>
            <p className="text-green-600 mt-1">Are you sure you want to approve this product request?</p>
          </div>
        </div>
